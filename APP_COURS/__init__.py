...
try:
    ...
    """
    from APP_COURS.database import database_tools
    from APP_COURS.demos_om_164 import routes_demos

    from APP_COURS.personnes import personnes_crud
    from APP_COURS.personnes import personnes_wtf_forms

    from APP_COURS.Fonction import fonction_crud
    from APP_COURS.Fonction import fonction_wtf_forms
    from APP_COURS.Personne_Fonction import personne_fonction_crud

    from APP_COURS.cours import cours_crud
    from APP_COURS.cours import cours_wtf_forms

    from APP_COURS.InscrireCours import InscrireCours_crud

    from APP_COURS.Payement import Payement_crud
    from APP_COURS.Payement import Payement_wtf

    from APP_COURS.Annulation import Annulation_crud
    from APP_COURS.Annulation import Annulation_wtf

    from APP_COURS.horaire import horaire_crud
    from APP_COURS.horaire import horaire_wtf_forms


    from APP_COURS.erreurs import msg_avertissements
